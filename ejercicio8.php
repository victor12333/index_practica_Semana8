...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $resultado = convertir_a_minusculas($cadena);
}
?>
...
<body>
    <h1>Convertir a Minúsculas</h1>
    <form method="POST" action="">
        <input type="text" name="cadena" placeholder="Ingresa una cadena" required>
        <button type="submit">Convertir a Minúsculas</button>
    </form>

    <?php if ($resultado): ?>
        <div class='alert alert-success'>La cadena en minúsculas es: <strong><?php echo $resultado; ?></strong></div>
    <?php endif; ?>
